...
export const FIGMA_FRAMES = [
  ...
  { route: '/actions',              frame: '12a Tonight — which night',      page: 0,  note: 'One evening, and the hour it becomes yours.' },
  ...
  { route: '/foundations',          frame: '18 Foundations — quality floor', page: 11, note: 'Bands, patterns, type scale. The design file cover page.' },
] as const;
