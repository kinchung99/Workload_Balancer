...
const SHOTS = [
  ['/',                       'home',       1560, 800, 20],
  ['/friends',                'friends',    1600, 800, 1],
  ['/friends',                'circle',     1600, 620, 500],
  ['/plan-together',          'together',   1100, 700, 200],
  ['/sharing',                'sharing',    1180, 760, 1],
  ['/find-friends',           'find-friends', 1120, 720, 1],
  ['/friend/ravi',            'friend-week', 1180, 760, 1],
  ['/you',                    'you',        1200, 700, 1],
  ['/add',                    'add-what',    880],
  ['/add/takes',              'add-takes',  1120, 750, 230],
  ['/add/when',               'add-when',   1080, 700, 250],
  ['/priority',               'priority',   1500, 750, 1],
  ['/priority',               'priority-move', 2900, 750, 1410],
  ['/plan',                   'plan',       1000],
  ['/plan',                   'day-bands',  1700, 590, 470],
  ['/plan',                   'owing-card', 1700, 590, 1030],
  ['/item/algo-set',          'item',       1100, 700, 120],
  ['/rebalance',              'swap',       1200, 480, 150],
  ['/rebalance',              'rebalance',  1400, 750, 430],
  ['/tonight/night',          'tonight',     880],
  ['/tonight/what',           'tonight-what', 1180, 750, 150],
  ['/tonight/what',           'tonight-custom', 1300, 475, 1075],
